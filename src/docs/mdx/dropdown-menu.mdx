...
A dropdown menu component that displays a menu when clicked.

<ComponentPreview demoName="dropdown-menu-demo" hint="Click to open menu" />
...
<ComponentPreview demoName="dropdown-menu-checkboxes" hint="Click to toggle checkboxes" />

### Radio Group

<ComponentPreview demoName="dropdown-menu-radio-group" hint="Click to select radio options" />
...
```js
/* [!code filename:dropdown-menu.tsx] */
