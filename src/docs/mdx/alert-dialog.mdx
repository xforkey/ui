...
export const description = "A modal dialog that interrupts the user with important content and expects a response.";
export const links = {
...
<ComponentPreview demoName="alert-dialog-demo"  />
...
<InstallBlock packageName="@radix-ui/react-alert-dialog" />
