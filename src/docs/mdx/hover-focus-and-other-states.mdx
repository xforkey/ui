...
import {svelte, html, css, tsx } from "@/docs/components/code-example.tsx";
...
import AccordionDemo from "@/docs/components/demos/accordion-demo";
...
<Preview padding={false} className="py-8">
  {
    <div className="">
...
<Preview padding={false} className="py-0">
  {
