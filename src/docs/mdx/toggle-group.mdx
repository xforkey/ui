...
<ComponentPreview demoName="toggle-group-demo" hint="A toggle group with multiple selection" />
...
<ComponentPreview demoName="toggle-group-single" hint="A toggle group with single selection" />
...
<ComponentPreview demoName="toggle-group-outline" hint="A toggle group with outline variant" />
...
<ComponentPreview demoName="toggle-group-disabled" hint="A disabled toggle group" />
...
<div className="flex flex-col space-y-4">
  <ComponentPreview demoName="toggle-group-sm" hint="A small toggle group" />
  <ComponentPreview demoName="toggle-group-demo" hint="A default size toggle group" />
  <ComponentPreview demoName="toggle-group-lg" hint="A large toggle group" />
</div>
