...
<ComponentPreview demoName="input-otp-demo" hint="Type or paste a code" />
...
<ComponentPreview demoName="input-otp-pattern" hint="Try typing letters and numbers" />
...
<ComponentPreview demoName="input-otp-separator" hint="Notice the separator between groups" />
...
<ComponentPreview demoName="input-otp-controlled" hint="Type to see controlled behavior" />

### Form

<ComponentPreview demoName="input-otp-form" hint="Try submitting the form" />
