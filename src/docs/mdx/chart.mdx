...
<ComponentPreview demoName="chart-bar-interactive" hint="Interactive bar chart example" />
...
<ComponentPreview demoName="chart-bar-demo" hint="Basic bar chart" />
...
<ComponentPreview demoName="chart-bar-demo-grid" hint="Bar chart with grid" />
...
<ComponentPreview demoName="chart-bar-demo-axis" hint="Bar chart with axis" />
...
<ComponentPreview demoName="chart-bar-demo-tooltip" hint="Bar chart with tooltip" />
...
<ComponentPreview demoName="chart-bar-demo-legend" hint="Bar chart with legend" />
...
<ComponentPreview demoName="chart-tooltip-demo" hint="Chart tooltip example" />
